...
const VALID_VIEW_MODES: ViewMode[] = [
  ...
  'guide', 'errors', 'brainstorm', 'dashboard', 'consistency', 'timeline', 'orphans', 'continuity', 'arc', 'prose', 'workshop', 'search', 'promises', 'glossary', 'completeness', 'heatmap', 'graph', 'factions',
];
