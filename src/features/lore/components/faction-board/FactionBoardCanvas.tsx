...
import {
  ...
  type Node, type Edge, type NodeChange, type NodeTypes, type EdgeTypes, type ColorMode,
} from '@xyflow/react';
...
import type { FactionBoardView } from '@/src/lib/factions';
...
function FactionBoardInner({ boardView, entryById, categories, colorMode, onOpenEntry, onPersistPosition }: Props) {
